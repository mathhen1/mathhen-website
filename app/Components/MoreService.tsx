...
const MoreService = () => {
    return (
        <div className="flex flex-col gap-3 bg-white text-black h-full">
            ...
            <div className="flex flex-col lg:flex-row gap-3 lg:w-11/12 lg:self-center lg:mt-5">
                <div className="flex flex-col gap-3 lg:w-1/2">
                    <h1 className="reveal opacity-0 max-lg:mt-8 mb-3 text-2xl lg:text-3xl font-extrabold ml-2 border-l-2 pl-1 w-11/12">
                        Por que devo ter um site?
                    </h1>

                    <p className="reveal-r opacity-0 text-xs lg:text-sm pl-2 text-gray-600 tracking-tighter border-2 p-2 w-10/12 ml-1 self-start">
                ...
                <div className="flex flex-col gap-3 lg:w-1/2">
                    <h1 className="reveal opacity-0 max-lg:mt-3 mb-2 text-2xl font-bold ml-2 border-l-2 pl-1 w-11/12">
            ...
            <a href={linkWpp} target="_blank" className="reveal-l opacity-0 mb-6 w-3/4 sm:w-1/4 border bg-black text-white font-black rounded-4xl p-2 text-center self-center font-mono 
