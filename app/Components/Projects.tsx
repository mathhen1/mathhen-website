...
const Projects = () => {
    ...
    return (
        <div className="flex flex-col lg:items-center gap-3 font-mono tracking-tighter bg-white text-black">

            <div className="flex flex-col gap-3 lg:w-10/12 lg:mt-5">
                <h1 className="reveal-l opacity-0 text-3xl pl-2 border-l-3 ml-2 font-bold lg:self-center">
                    Projetos
                </h1>

                <p className="reveal opacity-0 text-xs text-gray-800 self-center lg:text-base">
                ...
                <span onClick={() => router.push("/Projects")} className="reveal opacity-0 border-2 border-b-4 p-2 w-10/12 lg:w-1/3 self-center font-roboto font-black text-sm mb-10 flex flex-row justify-center items-center gap-2">
